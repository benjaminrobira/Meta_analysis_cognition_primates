...
# This script allows to fit diversification analysis (i.e. checking whether the evolutionary rate change with clades) based on the ClaDS algorithm.
# It is divided into three parts:

#1) Preparing the phylogenetic tree 
#2) Running the ClaDS algorithm
