...
traitName=c("EQ (log)", "Brain (/bodymass, log)", "Hippocampus (/brainsize, log)", "Neocortex (/brainsize, log)", "Cerebellum (/brainsize, log)", "Striatum (/brainsize, log)", "MOB (/brainsize, log)")
...
test2 <- get(paste("modelBrain", "Brain (/brainsize, log)", sep="_"))
...
pdf("Plots/selectionGradientPGLS_weightedBS.pdf", height=40, width=18)
source("T:/Saved_PhD/Empirical_analysis/Scripts&Functions/Functions/toolbox.R")
...
save.image("REnvironments/PGLSdirectionSelection_weightedBS.RData")
