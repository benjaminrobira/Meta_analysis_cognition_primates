...
# set_bold(row = which(toPlotBold[-(6:10)]), col = 2:ncol(results.df_gradient)) %>%
# 
# #Main layout
...
save.image("C:/Users/robira/Documents/PhD/Meta_analysis/Meta_analysis_cognition_primates/REnvironments/RDataforAppendix.RData")
```
